function S = SpectralArcLength( speed, Ts, parameters )
    %% Computes the smoothness of the give movement speed profile using the spectral arc length method.
    ...
    % Note: If the amplitude threshold argument is set by the user to
    % anything greater than zero, the output metric is SPARC. Otherwise,
    % the output metric is SAL - Barathwaj Murali 12/3/2020
